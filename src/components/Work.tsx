...
const featuredProjects = [
  {
    ...
    description: 'GCP-hosted SPA for analyzing match timeline data from the Riot match-v5 API.',
...
const projects = [
  {
    ...
    description: 'React-based Electron application scaffolded with Vite designed to fetch and parse bulk match data from Riot API.',
    liveUrl: '',
  ...
  },
  {
    ...
    description: 'Simple SPA to generate a secure password with the click of a button.',
